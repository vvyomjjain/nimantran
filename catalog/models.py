...
class Venue(models.Model):
    ...
    lat = models.DecimalField(help_text = "Latitude for the venue", null=True, blank=True, max_digits=10, decimal_places=7)
    lng = models.DecimalField(help_text = "Longitude for the venue", null=True, blank=True, max_digits=10, decimal_places=7)
